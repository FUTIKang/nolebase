...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright:
        '<a class="footer-cc-link" target="_blank" href="https://creativecommons.org/licenses/by-sa/4.0/">CC BY-SA 4.0</a> © 2022-PRESENT <a class="footer-cc-link" target="_blank" href="https://github.com/nolebase/nolebase">Nólëbase</a> 的创作者们',
    },
    search: {
      provider: 'local',
      options: {
